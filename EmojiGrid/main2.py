...
def abrir_archivo():
    ...
    pos = 0
    n = 0
    direcion = filedialog.askdirectory(initialdir='/', title='Seleccionar carpeta')
    if direcion:
        direcion = [os.path.join(direcion, filename) for filename in os.listdir(direcion) if filename.endswith('.mp3') or filename.endswith('.wav')]
        n = len(direcion)
        if n > 0:
            cancion_actual = direcion[pos]
            nombre_cancion = cancion_actual.split(os.path.sep)[-1]
...
estilo.configure("Vertical.TProgressbar", foreground='green2', background='green2',troughcolor='white',
	bordercolor='white',lightcolor='green2', darkcolor='green2')

frame1 = Frame(ventana, bg='white', width=600, height=350)
frame1.grid(column=0,row=0, sticky='nsew')
frame2 = Frame(ventana, bg='white', width=600, height=50)
...
estilo1.configure("Horizontal.TProgressbar", foreground='red', background='white',troughcolor='DarkOrchid1',
...
texto = Label(frame2, bg='white', fg='green2', width=5)
texto.grid(row=0,column=8)

nombre = Label(frame2, bg='white', fg='red', width=55)
nombre.grid(column=0, row=1, columnspan=8, padx=5)
cantidad = Label(frame2, bg='white', fg='green2')
...
style = ttk.Style()
style.configure("Horizontal.TScale", bordercolor='green2', troughcolor='white', background= 'green2', 
	foreground='green2',lightcolor='green2',darkcolor='white')  

nivel = Label(frame2, bg='white', fg='green2', width=3)
