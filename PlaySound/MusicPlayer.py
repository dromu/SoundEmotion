...
class MusicPlayer(QMainWindow):
    def __init__(self):
        ...
        self.ventana = loadUi(r"C:\Users\dromu\Unimayor\Urbanphony\SoundEmotion\PlaySound\Reproductor.ui", self)
        self.setWindowTitle("Music Player")

        # Crear una instancia de QMovie y asociarla con el QLabel
        self.gif_movie = QMovie(r"C:\Users\dromu\Unimayor\Urbanphony\SoundEmotion\PlaySound\Reproductor.gif")
    ...
    def play_music(self):
        ...
        folder_path = r"C:\Users\dromu\Unimayor\Urbanphony\SoundEmotion\Input\MVP1_2019"
